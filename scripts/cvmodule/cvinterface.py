...
class CVInterface():
    def __init__(self) -> None:
        self.detect_face = FaceLandmarker(args.faceLandmarkerModel, int(args.numFaces), args.minFaceDetectionConfidence,
                args.minFacePresenceConfidence, args.minFaceTrackingConfidence)

        self.detect_hand = HandGesture(args.handGestureModel, int(args.numHands), args.minHandDetectionConfidence,
    ...
    def get_face_info(self):
        ...
        while cap.isOpened():
            ...
            self.detect_face.start_detect(image, False)
            if self.detect_face.detect_result():
                return self.detect_face.detect_result()
        cap.release()
    ...
    def get_hand_info(self):
        ...
        while cap.isOpened():
            ...
            self.detect_hand.start_recognize(image, False)
            if self.detect_hand.detect_result() != None:
                return self.detect_hand.detect_result()
        cap.release()