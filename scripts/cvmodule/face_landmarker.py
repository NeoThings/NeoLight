...
class FaceLandmarker():
    def __init__(self, model: str, num_faces: int,
        ...
        self.label_background_color = (255, 255, 255)  # White
        self.label_padding_width = 1500  # pixels
    ...
    def start_detect(self, img, draw = True):
        ...
        if not draw:
            ...
            if DETECTION_RESULT:
                ...
                legend_x = current_frame.shape[
                                1] - self.label_padding_width + 20  # Starting X-coordinate (20 as a margin)
                legend_y = 30  # Starting Y-coordinate
                bar_max_width = self.label_padding_width - 40  # Max width of the bar with some margin
